export const i18n = {
  ...
  'ru-ru': {
    ...
    stories: {
      cat: 'Истории Vibe',
      title: 'Каждый, <br><span class="highlight">кто создаёт.</span>',
      sub: 'Посмотрите, как люди с самым разным опытом решают реальные задачи с помощью ИИ.',
      s1: {
        title:
          'Он отказался от высокой зарплаты, чтобы научить сельских детей «отгонять мух с помощью ИИ»',
        author: 'Сяохао, учитель начальной школы'
      },
      s2: {
        title:
          'В сессию я тайком собрал на ИИ «студенческую барахолку»',
        author: 'Студент второго курса'
      },
      s3: {
        title: 'Я сделал каждому ученику неутомимого ИИ-соседа по парте',
        author: 'Учитель информатики'
      },
      s4: {
        title:
          '48-летний дальнобойщик ночами собрал на ИИ сервис для зарубежного рынка',
        author: 'Лао Хуан, дальнобойщик'
      },
      authorPrefix: 'Автор:',
      ui: {
        prevLabel: 'Предыдущая история',
        nextLabel: 'Следующая история',
        selectLabel: 'Открыть историю',
        imageAlt: 'Обложка истории Vibe'
      }
    },
    stage1: {
      cat: 'Этап 1 · Начало пути',
      title: 'С нуля до героя, <br><span class="highlight">будь сам себе продактом.</span>',
      sub: 'Не нужно образование в IT. Просто опишите идею словами — ИИ превратит её в готовый прототип веб-приложения.',
      cards: [
        {
          title: 'Карта обучения',
          desc: 'Полный путь обучения от полного нуля до фулстек-разработки.',
          sub: 'Подходит для всех',
          link: '/ru-ru/stage-1/learning-map/'
        },
        {
          title: 'Игровое введение',
          desc: 'Почувствуйте магию программирования с ИИ, собирая игры вроде «Змейки».',
          sub: 'Учимся играя',
          link: '/ru-ru/stage-1/ai-capabilities-through-games/'
        },
        {
          title: 'Vibe Coding',
          desc: 'Освойте суть программирования с ИИ: от идеи продукта до интерактивного прототипа.',
          sub: 'Ключевое мышление',
          link: '/ru-ru/stage-1/learning-map/'
        }
      ]
    },
    stage2: {
      cat: 'Этап 2 · Младший/средний разработчик',
      title:
        'Стань фулстеком, <br><span class="highlight">создавай настоящие приложения.</span>',
      sub: 'Пройдите весь путь от фронтенда к бэкенду, базе данных и развёртыванию.',
      cards: [
        {
          title: 'Агент для ассетов',
          headline: 'Ускорьте создание контента.',
          desc: 'Соберите собственный конвейер производства материалов и агента для рисования на базе Lovart и Nanobanana.',
          link: '/ru-ru/stage-2/frontend/lovart-assets/'
        },
        {
          title: 'Figma и MasterGo',
          headline: 'Освойте инструменты дизайна.',
          desc: 'Изучите основы современных инструментов UI-дизайна и то, как макеты переходят в разработку.',
          link: '/ru-ru/stage-2/frontend/figma-mastergo/'
        },
        {
          title: 'Из дизайна в код',
          headline: 'Превращайте макеты в страницы.',
          desc: 'Преобразуйте прототипы в реальный фронтенд-код, работающий в браузере, а не в статичные картинки.',
          link: '/ru-ru/stage-2/frontend/design-to-code/'
        },
        {
          title: 'Проект с реальными данными',
          headline: 'На настоящей БД.',
          desc: 'Спроектируйте таблицы и права доступа в Supabase и свяжите их с реальными операциями чтения/записи.',
          link: '/ru-ru/stage-2/backend/database-supabase/'
        },
        {
          title: 'Развёртывание',
          headline: 'Покажите миру.',
          desc: 'С помощью CloudBase, Vercel и Zeabur превратите локальный проект в публично доступный сайт.',
          link: '/ru-ru/stage-2/backend/zeabur-deployment/'
        },
        {
          title: 'База знаний с ИИ',
          headline: 'Встройте ИИ в приложение.',
          desc: 'Используйте Dify для создания ИИ-сценариев и продуктов на основе базы знаний.',
          link: '/ru-ru/stage-2/ai-capabilities/dify-knowledge-base/'
        }
      ]
    },
    stage3: {
      cat: 'Этап 3 · Старший разработчик',
      title:
        'Продвинутая практика, <br><span class="highlight">безграничные возможности.</span>',
      sub: 'Кроссплатформенные приложения и AI-native процессы на базе Claude Code.',
      cards: [
        {
          title: 'Десктоп на Electron',
          desc: 'Соберите приложение для распознавания речи, работающее на Windows, macOS и Linux из одной кодовой базы.',
          link: '/ru-ru/stage-3/cross-platform/electron-voice-to-text/'
        },
        {
          title: 'Команды агентов',
          desc: 'Используйте Claude Agent Teams, чтобы управлять несколькими агентами как настоящей командой разработки.',
          link: '/ru-ru/stage-3/core-skills/agent-teams/'
        },
        {
          title: 'Долгие задачи',
          desc: 'Спроектируйте циклы и очереди задач, чтобы Claude Code мог безопасно работать всю ночь до завершения.',
          link: '/ru-ru/stage-3/core-skills/long-running-tasks/'
        },
        {
          title: 'Личный бренд',
          desc: 'Создайте свой сайт и технический блог, чтобы показывать проекты и тексты.',
    ...
    appendix: {
      cat: 'Приложение',
      title:
        'Энциклопедия, <br><span class="highlight">прочный фундамент.</span>',
      sub: 'От компьютерных сетей до принципов ИИ — соберите весь технический пазл.',
      cards: [
        {
          title: 'История ИИ',
          desc: 'Вехи развития искусственного интеллекта.',
          link: '/zh-cn/appendix/8-artificial-intelligence/ai-history'
        },
        {
          title: 'Промпт-инжиниринг',
          desc: 'Освойте навыки общения с ИИ.',
          link: '/zh-cn/appendix/8-artificial-intelligence/prompt-engineering'
        },
        {
          title: 'Введение в LLM',
          desc: 'Как устроены большие языковые модели.',
          link: '/zh-cn/appendix/8-artificial-intelligence/llm-principles'
        },
        {
          title: 'ИИ-агенты',
          desc: 'ИИ, принимающий решения самостоятельно.',
          link: '/zh-cn/appendix/8-artificial-intelligence/ai-agents'
        },
        {
          title: 'Основы веба',
          desc: 'Базовые HTML/CSS/JS.',
          link: '/zh-cn/appendix/3-browser-and-frontend/javascript-deep-dive'
        },
        {
          title: 'Эволюция фронтенда',
          desc: 'Развитие фронтенд-стека.',
          link: '/zh-cn/appendix/3-browser-and-frontend/frontend-frameworks'
        },
        {
          title: 'Архитектура бэкенда',
          desc: 'От монолита к микросервисам.',
          link: '/zh-cn/appendix/4-server-and-backend/backend-layered-architecture'
        },
        {
          title: 'Языки бэкенда',
          desc: 'Выбор подходящего стека.',
          link: '/zh-cn/appendix/4-server-and-backend/backend-languages'
        },
        {
          title: 'Базы данных',
          desc: 'Ключевые принципы хранения данных.',
          link: '/zh-cn/appendix/5-data/database-fundamentals'
        },
        {
          title: 'Дизайн API',
          desc: 'Проектирование надёжных интерфейсов.',
          link: '/zh-cn/appendix/4-server-and-backend/api-intro'
        },
        {
          title: 'Git',
          desc: 'Мастерство контроля версий.',
          link: '/zh-cn/appendix/2-development-tools/git-version-control'
        },
        {
          title: 'Сети',
          desc: 'Протоколы и связь.',
          link: '/zh-cn/appendix/1-computer-fundamentals/computer-networks'
        }
      ]
    },
    footer: {
      title: 'Готовы начать?',
      desc: 'Easy-Vibe — сделайте программирование таким же естественным, как дыхание.',
      btn: 'Начать сейчас'
    }
  },
  'ja-jp': {
