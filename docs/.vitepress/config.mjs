...
const docFooterLabels = {
  ...
  'ru-ru': { prev: 'Предыдущая страница', next: 'Следующая страница' }
}

const productManagerSidebarRu = [
  {
    text: 'Начало пути',
    collapsed: false,
    items: [
      { text: 'Карта обучения', link: '/ru-ru/stage-1/learning-map/' },
      {
        text: 'Эпоха ИИ: умеешь говорить — умеешь программировать',
        link: '/ru-ru/stage-1/ai-capabilities-through-games/'
      }
    ]
  },
  {
    text: 'Навыки прототипирования продукта',
    collapsed: false,
    items: [
      {
        text: 'Освойте инструменты ИИ-программирования',
        link: '/ru-ru/stage-1/introduction-to-ai-ide/'
      },
      {
        text: 'Найдите хорошую идею',
        link: '/ru-ru/stage-1/finding-great-idea/'
      },
      {
        text: 'Создайте прототип продукта',
        link: '/ru-ru/stage-1/building-prototype/'
      },
      {
        text: 'Подключите возможности ИИ',
        link: '/ru-ru/stage-1/integrating-ai-capabilities/'
      },
      {
        text: 'Полноценный проект на практике',
        link: '/ru-ru/stage-1/complete-project-practice/'
      }
    ]
  },
  {
    text: 'Приложение: бизнес-мышление',
    collapsed: false,
    items: [
      {
        text: 'Продуктовое мышление и проектирование решений',
        link: '/ru-ru/stage-1/appendix-a-product-thinking/'
      },
      {
        text: 'Сценарии применения ИИ в индустрии (B2B)',
        link: '/ru-ru/stage-1/appendix-industry-scenarios/'
      },
      {
        text: 'Идеи потребительских сценариев ИИ (B2C)',
        link: '/ru-ru/stage-1/appendix-c-consumer-scenarios/'
      }
    ]
  },
  {
    text: 'Приложение: исследование пользователей',
    collapsed: false,
    items: [
      {
        text: 'Где искать идеи: 3 источника для новичков',
        link: '/ru-ru/stage-1/appendix-idea-sources/'
      },
      {
        text: 'Двойной ромб: сначала правильное дело, потом — правильно',
        link: '/ru-ru/stage-1/appendix-double-diamond/'
      },
      {
        text: 'Jobs to Be Done: что пользователь хочет сделать на самом деле',
        link: '/ru-ru/stage-1/appendix-jobs-to-be-done/'
      },
      {
        text: 'The Mom Test: метод пользовательских интервью',
        link: '/ru-ru/stage-1/appendix-mom-test/'
      }
    ]
  },
  {
    text: 'Приложение: технические решения',
    collapsed: false,
    items: [
      {
        text: 'Что делать при ошибках в коде',
        link: '/ru-ru/stage-1/appendix-b-common-errors/'
      },
      {
        text: 'Сравнение семи инструментов ИИ-программирования',
        link: '/ru-ru/stage-1/appendix-articles/example0-1/vibe-coding-tools-snake-game-tutorial'
      },
      {
        text: 'Проектирование сайтов с помощью агентов',
        link: '/ru-ru/stage-1/appendix-articles/example0-2/vibe-coding-tools-build-website-with-ai-coding-and-design-agents'
      }
    ]
  }
]

const stage2SidebarRu = [
  {
    text: 'Фронтенд-разработка',
    collapsed: false,
    items: [
      {
        text: 'Производство ассетов и сборка агента',
        link: '/ru-ru/stage-2/frontend/lovart-assets/'
      },
      {
        text: 'Основы Figma и MasterGo',
        link: '/ru-ru/stage-2/frontend/figma-mastergo/'
      },
      {
        text: 'UI-гайдлайны и интерфейсы нескольких продуктов',
        link: '/ru-ru/stage-2/frontend/multi-product-ui/'
      },
      {
        text: 'Улучшение интерфейса с LLM и Skills',
        link: '/ru-ru/stage-2/frontend/llm-skills-beautiful/'
      },
      {
        text: 'Из прототипа дизайна в код проекта',
        link: '/ru-ru/stage-2/frontend/design-to-code/'
      },
      {
        text: 'Современные библиотеки компонентов',
        link: '/ru-ru/stage-2/frontend/modern-component-library/'
      }
    ]
  },
  {
    text: 'Бэкенд и фулстек',
    collapsed: false,
    items: [
      {
        text: 'Базы данных и Supabase',
        link: '/ru-ru/stage-2/backend/database-supabase/'
      },
      {
        text: 'Проектирование и разработка API',
        link: '/ru-ru/stage-2/backend/ai-interface-code/'
      },
      {
        text: 'Работа с Git и GitHub',
        link: '/ru-ru/stage-2/backend/git-workflow/'
      },
      {
        text: 'Развёртывание веб-приложения',
        link: '/ru-ru/stage-2/backend/zeabur-deployment/'
      },
      {
        text: 'Современные CLI-инструменты разработки',
        link: '/ru-ru/stage-2/backend/modern-cli/'
      },
      {
        text: 'Интеграция платежей Stripe',
        link: '/ru-ru/stage-2/backend/stripe-payment/'
      }
    ]
  },
  {
    text: 'Приложение: возможности ИИ',
    collapsed: false,
    items: [
      {
        text: 'ИИ 1: Dify и база знаний',
        link: '/ru-ru/stage-2/ai-capabilities/dify-knowledge-base/'
      }
    ]
  },
  {
    ...
    items: [
      {
        text: 'Проект «Портреты Хогвартса»',
        link: '/ru-ru/stage-2/frontend/hogwarts-portraits/'
      },
      {
        text: 'SaaS для маркетинговых текстов на ИИ',
        link: '/ru-ru/stage-2/assignments/copywriting-platform-supabase/'
      },
      {
        text: 'Система онлайн-экзаменов и управления',
        link: '/ru-ru/stage-2/assignments/exam-management-express/'
      },
      {
        text: 'Современный SaaS для генерации изображений',
        link: '/ru-ru/stage-2/assignments/modern-landing-page/'
      },
      {
        text: 'Платформа ИИ-агентов в стиле Dify',
        link: '/ru-ru/stage-2/assignments/custom-dify-agent-platform/'
      },
      {
        text: 'Платформа агента для планирования путешествий',
        link: '/ru-ru/stage-2/assignments/travel-planning-agent-platform/'
      },
      {
        text: 'Рекомендатель фильмов на Spring Boot',
        link: '/ru-ru/stage-2/assignments/movie-recommendation-springboot/'
      },
      {
        text: 'Микросервисная система для продуктового магазина',
        link: '/ru-ru/stage-2/assignments/simple-grocery-microservices/'
      },
      {
        text: 'Платформа транспортных данных на Go',
        link: '/ru-ru/stage-2/assignments/traffic-data-visualization-go/'
      }
    ]
  }
]

const stage3SidebarRu = [
  {
    text: 'Ключевые навыки',
    collapsed: false,
    items: [
      {
        text: 'Быстрый старт с Claude Code',
        link: '/ru-ru/stage-3/core-skills/basics/'
      },
      {
        text: 'Полный гайд по MCP и Claude Code',
        link: '/ru-ru/stage-3/core-skills/mcp/'
      },
      {
        text: 'Полный гайд по Claude Code Skills',
        link: '/ru-ru/stage-3/core-skills/skills/'
      },
      {
        text: 'Claude Code в долгих задачах',
        link: '/ru-ru/stage-3/core-skills/long-running-tasks/'
      },
      {
        text: 'Полный гайд по командам агентов Claude',
        link: '/ru-ru/stage-3/core-skills/agent-teams/'
      },
      {
        text: 'Claude Code для продакшен-разработки',
        link: '/ru-ru/stage-3/core-skills/superpowers/'
      },
      {
        text: 'Рабочий процесс разработки с ИИ',
        link: '/ru-ru/stage-3/core-skills/workflow/'
      },
      {
        text: 'Удалённая разработка с Claude Code на телефоне',
        link: '/ru-ru/stage-3/core-skills/mobile-development/'
      },
      {
        text: 'Полный гайд по Claude Agent SDK',
        link: '/ru-ru/stage-3/core-skills/claude-agent-sdk/'
      },
      {
        text: 'От Vibe Coding к Spec Coding',
        link: '/ru-ru/stage-3/core-skills/spec-coding/'
      }
    ]
  },
  {
    ...
    items: [
      {
        text: 'Как выбрать платформу для приложения',
        link: '/ru-ru/stage-3/cross-platform/choose-platform/'
      },
      {
        text: 'Как сделать простой мини-апп WeChat',
        link: '/ru-ru/stage-3/cross-platform/wechat-miniprogram/'
      },
      {
        text: 'Мини-апп WeChat с бэкендом',
        link: '/ru-ru/stage-3/cross-platform/wechat-miniprogram-backend/'
      },
      {
        text: 'Android-приложение на Jetpack Compose',
        link: '/ru-ru/stage-3/cross-platform/android-app/'
      },
      {
        text: 'iOS-приложение на SwiftUI',
        link: '/ru-ru/stage-3/cross-platform/ios-app/'
      },
      {
        text: 'Как сделать локальное PWA',
        link: '/ru-ru/stage-3/cross-platform/pwa-local-app/'
      },
      {
        text: 'ИИ-ассистент как расширение браузера',
        link: '/ru-ru/stage-3/cross-platform/browser-ai-extension/'
      },
      {
        text: 'Кроссплатформенное приложение на Electron',
        link: '/ru-ru/stage-3/cross-platform/electron-voice-to-text/'
      },
      {
        text: 'Как быстро создать и выпустить NFT',
        link: '/ru-ru/stage-3/cross-platform/nft-minting/'
      },
      {
        text: 'Как сделать расширение для VS Code',
        link: '/ru-ru/stage-3/cross-platform/vscode-extension/'
      },
      {
        text: 'Промышленное десктоп-приложение на Qt',
        link: '/ru-ru/stage-3/cross-platform/qt-industrial-hmi/'
      },
      {
        text: 'Личный сайт и научный блог',
        link: '/ru-ru/stage-3/personal-brand/personal-website-blog/'
      }
    ]
  },
  {
    ...
    items: [
      {
        text: 'Что такое RAG и как он работает',
        link: '/ru-ru/stage-3/ai-advanced/rag-introduction/'
      },
      {
        text: 'Продвинутый RAG и оркестрация на LangGraph',
        link: '/ru-ru/stage-3/ai-advanced/langgraph-advanced-rag/'
      }
    ]
  }
]
...
`
  ...
  locales: {
    ...
    'ru-ru': {
      ...
      lang: 'ru-RU',
      link: '/ru-ru/',
      title: 'Учебник Easy-Vibe',
      description:
        'Изучите Vibe Coding с нуля до продвинутого уровня — освойте программирование с ИИ: Claude Code, Cursor и другие AI IDE',
      head: getSeoHead(
        'ru-ru',
        'Учебник Easy-Vibe',
        'Изучите Vibe Coding с нуля до продвинутого уровня — освойте программирование с ИИ: Claude Code, Cursor и другие AI IDE'
      ...
      themeConfig: {
        ...
        notFound: {
          ...
          quote: 'Страница, которую вы ищете, не существует или была перемещена.',
          linkText: 'На главную',
          linkUrl: '/ru-ru/'
        },
        outline: {
        ...
        docFooter: docFooterLabels['ru-ru'],
        nav: [
          { text: 'Главная', link: '/ru-ru/' },
          {
            text: 'Для начинающих',
            link: '/ru-ru/stage-1/learning-map/',
            activeMatch: '/ru-ru/stage-1/'
          },
          {
            text: 'Фулстек-разработка',
            link: '/ru-ru/stage-2/frontend/lovart-assets/',
            activeMatch: '/ru-ru/stage-2/'
          },
          {
            text: 'Продвинутая разработка',
            link: '/ru-ru/stage-3/core-skills/basics/',
            activeMatch: '/ru-ru/stage-3/'
          },
          {
            text: 'Приложение',
