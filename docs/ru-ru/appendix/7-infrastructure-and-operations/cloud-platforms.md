...
- **基础网络概念**：如果你还不熟悉 IP 地址、端口、域名等概念，建议先阅读 [网络基础知识](/ru-ru/appendix/1-computer-fundamentals/computer-networks)
- **API 是什么**：如果你对 API 还不了解，可以先看 [API 入门](/ru-ru/appendix/4-server-and-backend/api-intro)
