...
Если хотите научиться писать более качественные промпты, посмотрите [Приложение по инженерии промптов](/zh-cn/appendix/8-artificial-intelligence/prompt-engineering).
...
Если хотите глубже погрузиться в основы фронтенда вроде HTML, CSS и JavaScript, посмотрите [Приложение по основам веба](/zh-cn/appendix/3-browser-and-frontend/javascript-deep-dive). Чтобы узнать об эволюции фронтенд-технологий, посмотрите [Приложение по эволюции фронтенда](/zh-cn/appendix/3-browser-and-frontend/frontend-frameworks).
