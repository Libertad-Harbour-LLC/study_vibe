...
![](../../../../ru-ru/stage-1/appendix-articles/example0-1/images/image1.png)
...
![](../../../../ru-ru/stage-1/appendix-articles/example0-1/images/image2.png)
...
- **Процесс работы с промптами:**
  ![](../../../../ru-ru/stage-1/appendix-articles/example0-1/images/image3.png)
- **Результаты игры Snake:**

![](../../../../ru-ru/stage-1/appendix-articles/example0-1/images/image4.png)
![](../../../../ru-ru/stage-1/appendix-articles/example0-1/images/image5.png)
...
- **Цена:** относительно дорого, но если у вас есть учебная электронная почта, вы можете подтвердить статус студента и использовать её за полцены.
  ![](../../../../ru-ru/stage-1/appendix-articles/example0-1/images/image6.png)
...
- **Процесс работы с промптами:**
  ![](../../../../ru-ru/stage-1/appendix-articles/example0-1/images/image7.png)
- **Результаты игры Snake:**

![](../../../../ru-ru/stage-1/appendix-articles/example0-1/images/image8.png)
![](../../../../ru-ru/stage-1/appendix-articles/example0-1/images/image9.png)

- **Цена:**
  ![](../../../../ru-ru/stage-1/appendix-articles/example0-1/images/image10.png)
...
- **Процесс работы с промптами:**
  ![](../../../../ru-ru/stage-1/appendix-articles/example0-1/images/image11.png)
- **Результаты игры Snake:**

![](../../../../ru-ru/stage-1/appendix-articles/example0-1/images/image12.png)
![](../../../../ru-ru/stage-1/appendix-articles/example0-1/images/image13.png)

- **Цена:**
  ![](../../../../ru-ru/stage-1/appendix-articles/example0-1/images/image14.png)
...
- **Ключевые функции и рабочий процесс:** Replit — это универсальная онлайн-среда разработки и развёртывания: вы можете писать код, запускать программы и генерировать ссылки для онлайн-доступа прямо в браузере. Перед началом кодирования она даёт вам понятный план действий; она также предоставляет визуальный редактор, где вы можете напрямую изменять UI в окне предпросмотра, а исходный код автоматически синхронизируется. Это позволяет вам в любой момент проверить, соответствует ли вывод AI ожиданиям, значительно сокращая количество циклов исправлений.
  ...
  ![](../../../../ru-ru/stage-1/appendix-articles/example0-1/images/image15.png)
...
- **Процесс работы с промптами:** в процессе сборки AI поначалу не полностью понял требования — потребовалось около 3 раундов итераций, прежде чем итоговый результат достиг идеального состояния.
  ![](../../../../ru-ru/stage-1/appendix-articles/example0-1/images/image16.png)
- **Результаты игры Snake:**

![](../../../../ru-ru/stage-1/appendix-articles/example0-1/images/image17.png)
![](../../../../ru-ru/stage-1/appendix-articles/example0-1/images/image18.png)

- **Цена:**
  ![](../../../../ru-ru/stage-1/appendix-articles/example0-1/images/image19.png)
...
- **Процесс работы с промптами:**
  ![](../../../../ru-ru/stage-1/appendix-articles/example0-1/images/image20.png)
- **Результаты игры Snake:**

![](../../../../ru-ru/stage-1/appendix-articles/example0-1/images/image21.png)
![](../../../../ru-ru/stage-1/appendix-articles/example0-1/images/image22.png)

- **Цена:**
  ![](../../../../ru-ru/stage-1/appendix-articles/example0-1/images/image23.png)
...
- **Процесс работы с промптами:**
  ![](../../../../ru-ru/stage-1/appendix-articles/example0-1/images/image24.png)
- **Результаты игры Snake:**

![](../../../../ru-ru/stage-1/appendix-articles/example0-1/images/image25.png)
![](../../../../ru-ru/stage-1/appendix-articles/example0-1/images/image26.png)

- **Цена:**
  ![](../../../../ru-ru/stage-1/appendix-articles/example0-1/images/image27.png)
...
- **Процесс работы с промптами:** Copilot работает иначе — он предоставляет встроенные подсказки по мере того, как вы печатаете, а не генерирует целые проекты через диалоги. Вы можете писать комментарии или имена функций, и Copilot предложит реализации.
  ![](../../../../ru-ru/stage-1/appendix-articles/example0-1/images/image28.png)
- **Результаты игры Snake:**

![](../../../../ru-ru/stage-1/appendix-articles/example0-1/images/image29.png)
![](../../../../ru-ru/stage-1/appendix-articles/example0-1/images/image30.png)

- **Цена:**
  ![](../../../../ru-ru/stage-1/appendix-articles/example0-1/images/image31.png)
...
![](../../../../ru-ru/stage-1/appendix-articles/example0-1/images/image32.png)
